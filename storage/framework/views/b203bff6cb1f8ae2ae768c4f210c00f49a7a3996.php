  <div class="col-md-3 chnages_list">
                  ...
                  <ul>
					 <li class="<?if($title=='My dashboard'){?>active<?}?>">
                        <a href="<?php echo e(URL::to('myaccount')); ?>">My Dashboard</a>
                     </li>
					  
                     <li class="<?if($title=='Account Information'){?>active<?}?>">
                        <a href="<?php echo e(URL::to('account_information')); ?>">Account Information</a>
                     </li>
                     <li class="<?if($title=='Account Address'){?>active<?}?>">
                        <a href="<?php echo e(URL::to('address')); ?>">Address Book</a>
                     </li>
                     <li class="<?if($title=='Change Password'){?>active<?}?>">
                        <a href="<?php echo e(URL::to('changePassword')); ?>">Change Password</a>
                     </li>
                     ...
                     <div id="panel_mngg" style="display: none;">
                         <ul>
                             <li><a href="<?php echo e(URL::to('order_list')); ?>">Your Order</a></li>
<!--                             <li><a href="#">Return Order</a></li>-->
                     ...
                     <li class="<?if($title=='Wishlist'){?>active<?}?>">
                        <a href="<?php echo e(URL::to('user_wishlist')); ?>">Wishlist</a>
                     </li>
                  </ul>
               </div>