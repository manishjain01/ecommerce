...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box-header with-border">
            <h3 class="pull-right">  
                <?php echo Html::decode(Html::link(route('admin.subsubindex', $subslug),"<i class='fa  fa-arrow-left'></i>".trans('admin.BACK'),['class'=>'btn btn-block btn-primary'])); ?>
        ...
        <div class="box box-primary">
            ...
            <?php echo Form::model($category,['route'=>['admin.editsubcategory.update',$category->slug, $mainslug],'files'=>true]); ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group ">
                                <?php echo Form::label('Sub Category Name',null,['class'=>'required_label']); ?>

                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <?php echo Form::text('cat_name',null,['class'=>'form-control','placeholder'=>'Sub Category Name']); ?>
