...
<?php $__env->startSection('content'); ?><?php //pr($datas);exit;?>
<section id="mustHave-products-area" class="pt-90 pt-md-60 pt-sm-50 products_listing_sec">
	...
	<input type='hidden' name='item_name' value='{{$order->product_name}}'>
        @endforeach <?php */?>
        <input type='hidden' name='item_name[]' value='<?php echo e($datas); ?>'>
	<input type='hidden' name='quantity' value='1'>
        <input type='hidden' name='custom' value='<?php echo e($orders->order_no); ?>'>
	<input type='hidden' name='amount' value='<?php echo e($orders->item_total_amount); ?>'>
	<input type='hidden' name='shipping' value="<?php echo e($orders->shipping_amount); ?> }}">
	<input type='hidden' name='currency_code' value='USD'>
	<input type='hidden' name='notify_url' value='<?php echo e(URL::to('payment-process')); ?>'>
	<input type='hidden' name='cancel_return' value="<?php echo e(URL::to('payment-cancel')); ?>">
	<input type='hidden' name='return' value="<?php echo e(URL::to('payment-success')); ?>" />
