...
<section class="content-header">
  ...
  <?php echo Html::decode(Html::link(route('admin.pincode.create'),"<i class='fa  fa-plus'></i>",['class'=>'btn btn-primary','data-toggle'=>'tooltip','title'=>trans('Add')])); ?>				  
...
<!--                  <th  width="15%" align="center"><?php echo e(trans('admin.PROFILE_IMAGE')); ?></th>-->
			  <th width="5%">S.No</th>
              <th width="15%"><?php echo \Kyslik\ColumnSortable\Sortable::link(array ('pincode', 'Pincode'));?></th>
           ...
           <tr>
              ...
              <td><?php echo e(ucfirst($size->pincode)); ?></td>
              ...
              <td>
				  <?php echo Html::decode(Html::link(route('admin.pincode.edit', $size->id),"<i class='fa  fa-edit'></i>",['class'=>'btn btn-primary','data-toggle'=>'tooltip','title'=>trans('admin.EDIT')])); ?>				  
           ...
           <?php echo $sizes->appends(Input::all('pincode'))->render(); ?>
