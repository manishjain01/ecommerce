    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="pull-right">  
                   <?php if(isset($parent_id) && $parent_id!=NULL): ?>
                    <?php echo Html::decode(Html::link(route('admin.adminmenus.child_menu',['id'=>$parent_id]),"<i class='fa  fa-arrow-left'></i>".trans('admin.BACK'),['class'=>'btn btn-block btn-primary'])); ?>

                      <?php else: ?>
<?php echo Html::decode(Html::link(route('admin.adminmenus.index'),"<i class='fa  fa-arrow-left'></i>".trans('admin.BACK'),['class'=>'btn btn-block btn-primary'])); ?>

                      <?php endif; ?>
                </h3>
            </div>
            <?php echo Form::open(['method'=>'post','files'=>true,'route'=>['admin.adminmenus.store',$parent_id]]); ?>  
            <div class="box-body">
