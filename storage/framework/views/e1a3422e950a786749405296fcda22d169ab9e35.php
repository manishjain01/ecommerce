...
<nav class="navbar navbar-inverse sticky">
                ...
                <ul>
                    <li class="dropdown_wish_new">
                        ...
                        <div class="dropdown-content_wish_new">
                            ...
                            <a href="<?php echo e(URL::to('user_wishlist')); ?>" class="wish_listst">GO TO WISHLIST</a>
                            <?php endif; ?>
                        </div>
                    </li>
                    <?php
                    ...
                    ?>
                    <li>
			<a href="<?php echo e(URL::to('cartDetail/')); ?>" ><i class="fa fa-shopping-cart" aria-hidden="true"></i>
                            
                            <sup class="shopping-cart" <?php if(empty($countCart) && $countCart == 0){?> style="display:none;" <?php }?>>
                                
                                <?php echo e($countCart); ?>
                    ...
                    <?php if($auth): ?>
                    <li>
                        <?php echo HTML::link(route('myaccount'), ucfirst($auth->first_name), array('class' => '')); ?> |
                    ...
                    <li class="search-media-icon">
                        ...
                        <?php echo Form::open(array('route' => 'product_search', 'novalidate' => 'novalidate', 'id' => 'demo_2')); ?>
    ...
    <!--<div class="container-fluid">
      <div class="navbar-header col-md-4">
        ...
        <a class="navbar-brand" href="<?php echo e(URL::to('/')); ?>"><img src="<?php echo e(asset('img/logo.png')); ?>"></a>
      </div>
...
?>
          <li class="<?if($key == 0 ){?>active<? } ?> dropdown_nav"><a href="<?php echo e(URL::to('productCat/'.$catList->slug)); ?>" id="flip_drp<?php echo e($key); ?>" class="dropbtn_nav"><?php echo e(strtoupper($catList->cat_name)); ?></a>
                          
                          <?php if(!$catSubLists->isEmpty()): ?>
                          
                    <div class="dropdown-content_nav" id="panel_drp<?php echo e($key); ?>">
                            <?php foreach($catSubLists as $catSubList): ?>
                            <a href="<?php echo e(URL::to('productCat/'.$catList->slug.'/'.$catSubList->slug)); ?>"><?php echo e(ucfirst($catSubList->cat_name)); ?></a>
                            <?php endforeach; ?>
                  ...
                  $(document).ready(function(){
                          $("#flip_drp<?php echo e($key); ?>").click(function(){
                                  $("#panel_drp<?php echo e($key); ?>").slideToggle("slow");
                          });
                  });
                  </script>
          </li>
...
?>
            <div class="subnav1">
                <a href="<?php echo e(URL::to('productCat/'.$catList->slug)); ?>" class="subnavbtn1"><?php echo e(strtoupper($catList->cat_name)); ?></a><i class="fa fa-caret-down flip_drp<?php echo e($key); ?>" onclick="flip_drp(<?php echo e($key); ?>)" aria-hidden="true" id="flip_drp<?php echo e($key); ?>"></i>

                <?php if($catList->slug=='women'): ?>
                <div class="subnav-content1 women_cat_content panel_men<?php echo e($key); ?>" id="panel_men<?php echo e($key); ?>">
                    <?php else: ?>
                    <div class="subnav-content1 panel_men<?php echo e($key); ?>" id="panel_men<?php echo e($key); ?>">
                        <?php endif; ?>  
						...
						?>
                            ...
                            <div class="<?if($catList->slug=='men'){?> col-md-3 <?} else {?>col-md-4<? } ?>">
                                <ul>
                                    <a href="<?php echo e(URL::to('productCat/'.$catList->slug.'/'.$catSubList->slug)); ?>"><h4><?php echo e(ucfirst($catSubList->cat_name)); ?></h4></a>
                                    <?php foreach($catSubSubLists as $catSubSubList): ?>
                                    <li> <a href="<?php echo e(URL::to('productCat/'.$catList->slug.'/'.$catSubList->slug.'/'.$catSubSubList->slug)); ?>"><?php echo e(ucfirst($catSubSubList->cat_name)); ?></a></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                            <?php endforeach; ?>
	...
	<script>
		...
		$(document).ready(function () {
			$(".flip_drp<?php echo e($key); ?>").click(function () {
				$(".panel_men<?php echo e($key); ?>").toggle();
			});
		});*/
        $(document).ready(function(){
