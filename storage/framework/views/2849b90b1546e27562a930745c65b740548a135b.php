...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box-header with-border">
            <h3 class="pull-right">  
                <?php echo Html::decode(Html::link(route('admin.size.index'),"<i class='fa  fa-arrow-left'></i>".trans('admin.BACK'),['class'=>'btn btn-block btn-primary'])); ?>
        ...
        <div class="box box-primary">
            ...
            <?php echo Form::model($plan,['method'=>'patch','route'=>['admin.size.update',$plan->id],'files'=>true]); ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group ">
                                <?php echo Form::label('Size',null,['class'=>'required_label']); ?>

                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <?php echo Form::text('size',null,['class'=>'form-control','placeholder'=>'Size']); ?>

                                <div class="error"><?php echo e($errors->first('size')); ?></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="box-footer">
                <div class="pull-right">
                    ...
                    <?php echo Html::decode(Html::link(route('admin.size.index'),trans('admin.CANCEL'),['class'=>'btn btn-default'])); ?>
