...
<section class="content-header">
  ...
  <?php echo Html::decode(Html::link(route('admin.addsubsubcategory', [$slug, $subslug]),"<i class='fa  fa-plus'></i>",['class'=>'btn btn-primary','data-toggle'=>'tooltip','title'=>trans('Add')])); ?>				  
...
<!--                  <th  width="15%" align="center"><?php echo e(trans('admin.PROFILE_IMAGE')); ?></th>-->
              <th width="5%">S.No</th>
              <th width="15%"><?php echo \Kyslik\ColumnSortable\Sortable::link(array ('cat_name', 'Sub Sub Category'));?></th>
              <th width="15%"><?php echo \Kyslik\ColumnSortable\Sortable::link(array ('cat_name', 'Sub Category'));?></th>
              <th width="15%"><?php echo \Kyslik\ColumnSortable\Sortable::link(array ('cat_name', 'Main Category'));?></th>
           ...
           <tr>
              ...
              <td><?php echo e(ucfirst($subcategory->cat_name)); ?></td>
              <td><?php echo e(ucfirst($maincategory->cat_name)); ?></td>
              ...
              <td>
                        <?php echo Html::decode(Html::link(route('admin.editsubsubcategory', [$category->slug, $slug, $subslug]),"<i class='fa  fa-edit'></i>",['class'=>'btn btn-primary','data-toggle'=>'tooltip','title'=>trans('admin.EDIT')])); ?>				  
