                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <div class="pull-right">
                            ...
                            <?php echo Html::decode(Html::link(route('admin.adminmenus.create',$parent_id),"<i class='fa  fa-plus'></i>".trans('admin.ADD_NEW'),['class'=>'btn btn-primary'])); ?> 
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <?php echo Html::decode(Html::link(route('admin.adminmenus.status_change',['id' => $admin_menu->id,'status'=>$admin_menu->status,'parent_id'=>$parent_id]),"<i class='fa  fa-check'></i>",['class'=>'btn btn-success confirm_link','data-toggle'=>'tooltip','title'=>trans('admin.ACTIVE'), "data-alert"=>trans('admin.INACTIVE_ALERT')])); ?>

                                        <?php else: ?>
                                        <?php echo Html::decode(Html::link(route('admin.adminmenus.status_change',['id' => $admin_menu->id,'status'=>$admin_menu->status,'parent_id'=>$parent_id]),"<i class='fa  fa-remove'></i>",['class'=>'btn btn-danger confirm_link','data-toggle'=>'tooltip','title'=>trans('admin.INACTIVE'), "data-alert"=>trans('admin.ACTIVE_ALERT')])); ?>

                                        <?php endif; ?>
                                        <?php echo Html::decode(Html::link(route('admin.adminmenus.edit',['id'=>$admin_menu->id,'parent_id'=>$parent_id]),"<i class='fa  fa-edit'></i>",['class'=>'btn btn-primary','data-toggle'=>'tooltip','title'=>trans('admin.EDIT')])); ?>
