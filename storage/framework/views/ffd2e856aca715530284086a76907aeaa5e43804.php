...
<footer id="footer-area">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="footer-widget-item-wrap add_p">
                            ...
                            <div class="widget-body">
                                <ul class="footer-list">
                                    <li><a href="javascript:void(0);"><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo Configure('CONFIG_POSTAL_ADDRESS'); ?></a></li>
                                    <li><a href="javascript:void(0);"><i class="fa fa-phone" aria-hidden="true"></i> <?php echo e(Configure('CONFIG_PHONE')); ?></a></li> 
                                    <li><a href="javascript:void(0);"><i class="fa fa-envelope" aria-hidden="true"></i> <?php echo e(Configure('CONFIG_FROMEMAIL')); ?></a></li> 
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="footer-widget-item-wrap scl_ftr">
                            ...
                            <div class="widget-body">
                                <ul class="footer-list">
                                    <li><a href="<?php echo e(Configure('CONFIG_FACEBOOK')); ?>" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                    <li><a href="<?php echo e(Configure('CONFIG_LINKEDIN')); ?>" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                    <li><a href="<?php echo e(Configure('CONFIG_THUMBLR')); ?>" target="_blank"><i class="fa fa-tumblr" aria-hidden="true"></i></a></li>
                                    <li><a href="<?php echo e(Configure('CONFIG_PINTEREST')); ?>" target="_blank"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a></li>
                                    <li><a href="<?php echo e(Configure('CONFIG_TWITTER')); ?>" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                    <li><a href="<?php echo e(Configure('CONFIG_GPLUS')); ?>" target="_blank"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
                                    <li><a href="<?php echo e(Configure('CONFIG_IMGUR')); ?>" target="_blank"><i class="fa fa-picture-o" aria-hidden="true"></i></a></li>
                                </ul>
                                <p>100% Secure Payment</p>
                                <img src="<?php echo e(asset('img/pay.png')); ?>">
    ...
    <div class="footer-bottom-wrapper">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    <img src="<?php echo e(asset('img/logo-footer.png')); ?>">
                </div>
    ...
    font-size: 18px;">Subscribe For Newsletter</span>
                    <?php echo Form::open(array('novalidate' => 'novalidate','files'=>true,'id'=>'newsletter_form')); ?>
        ...
        <div class="minicart-product-list">
            <div class="single-product-item d-flex">
                <figure class="product-thumb">
                    <a href="single-product.html"><img src="<?php echo e(asset('img/products/prod-1-1.jpg')); ?>" alt="Product"></a>
                </figure>
            ...
            <div class="single-product-item d-flex">
                <figure class="product-thumb">
                    <a href="single-product.html"><img src="<?php echo e(asset('img/products/prod-2-1.jpg')); ?>" alt="Product"></a>
                </figure>
                <a href="#" class="remove-icon">&#215;</a>
            </div>
            ...
            <div class="single-product-item d-flex">
                <figure class="product-thumb">
                    <a href="single-product.html"><img src="<?php echo e(asset('img/products/prod-3-1.jpg')); ?>" alt="Product"></a>
                </figure>
                <a href="#" class="remove-icon">&#215;</a>
            </div>
            ...
            <div class="single-product-item d-flex">
                <figure class="product-thumb">
                    <a href="single-product.html"><img src="<?php echo e(asset('img/products/prod-4-1.jpg')); ?>" alt="Product"></a>
                </figure>
                <a href="#" class="remove-icon">&#215;</a>
            </div>
        </div>
                        ...
                        <div class="single-product-thumb-wrap p-0 pb-sm-30 pb-md-30">
                            <div class="quciview-product-thumb-carousel">
                                <figure class="product-thumb-item">
                                    <img src="<?php echo e(asset('img/products/prod-1-1.jpg')); ?>" alt="Single Product"/>
                                </figure>

                                <figure class="product-thumb-item">
                                    <img src="<?php echo e(asset('img/products/prod-1-2.jpg')); ?>" alt="Single Product"/>
                                </figure>

                                <figure class="product-thumb-item">
                                    <img src="<?php echo e(asset('img/products/prod-2-1.jpg')); ?>" alt="Single Product"/>
                                </figure>
                            </div>
                            ...
                            <div class="single-product-footer mt-20 pt-20">
                                <div class="prod-footer-right">
                                    <dl class="social-share">
                                        ...
                                        <dt>Share with</dt>
                                        <dd><a href="<?php echo e(Configure('CONFIG_FACEBOOK')); ?>"><i class="fa fa-facebook"></i></a></dd>
                                        <dd><a href="<?php echo e(Configure('CONFIG_TWITTER')); ?>"><i class="fa fa-twitter"></i></a></dd>
                                        <dd><a href="<?php echo e(Configure('CONFIG_PINTEREST')); ?>"><i class="fa fa-pinterest-p"></i></a></dd>
                                        <dd><a href="<?php echo e(Configure('CONFIG_GPLUS')); ?>"><i class="fa fa-google-plus"></i></a></dd>
...
<div id="myModal_login1" class="modal_login1">
    ...
    <div class="modal-content_login1 aaaa">
        ...
        <h2>Login</h2>
        <?php echo Form::open(array('novalidate' => 'novalidate','files'=>true,'id'=>'login_form')); ?>

        <input type="hidden" name="_Token" value="<?php echo e(csrf_token()); ?>">
        <div class="user-input-wrp"><br/>
            <?php echo Form::email('email',null,['class'=>'inputText', 'id'=>'email','required' => '']); ?>

            <span class="floating-label">Your email address</span>
        </div>
        <div class="user-input-wrp pas"><br/>
            <?php echo Form::password('password',['class'=>'inputText', 'id'=>'password','required' => '']); ?>
        ...
        <a href="<?php echo e(route('facebook.login')); ?>" class="btn btn-facebook text-center"><i class="fa fa-facebook"></i> Facebook</a>
        <a href="<?php echo e(route('instagram.login')); ?>" class="btn btn-instagram"><i class="fa fa-instagram"></i> Instagram</a>
        <?php endif; ?>
        </div>
        <?php echo Form::close(); ?>
    ...
    <div class="modal-content_login1 forgot_password" style="display:none;">
        ...
        <?php echo Form::open(array('novalidate' => 'novalidate','files'=>true,'id'=>'forgot_password')); ?>

        <input type="hidden" name="_Token" id="forgot_token" value="<?php echo e(csrf_token()); ?>">
        <div class="user-input-wrp"><br/>
            <?php echo Form::email('username',null,['class'=>'inputText', 'id'=>'username','placeholder'=>'Your email address','required' => '']); ?>
...
<!--            <span class="floating-label">Your email address</span>-->
        ...
        <?php echo Form::button('Email Reset Link',['class'=>'cs reset', 'id'=>'forgot_id']); ?>  
        <?php echo Form::close(); ?>
    ...
    <div class="modal-content_sign1">
        ...
        <div class="user_logg" style="min-height: 60px;">
            <div class="user-input-wrp user_input_wp1 user_input_w"><br/>
                <?php echo Form::text('first_name',null,['class'=>'inputText', 'id'=>'first_name','required' => '']); ?>
            ...
            <div class="user-input-wrp user_input_wp1"><br/>
                <?php echo Form::text('last_name',null,['class'=>'inputText', 'id'=>'last_name','required' => '']); ?>
        ...
        <div class="user-input-wrp"><br/>
            <?php echo Form::text('email',null,['class'=>'inputText', 'id'=>'email_register','required' => '']); ?>

            <span class="email_register_er error"></span>
            <span class="floating-label">Email Id</span>
        </div>
         <div class="user-input-wrp"><br/>
            <?php echo Form::text('phone',null,['class'=>'inputText', 'id'=>'phone','required' => '']); ?>
        ...
        <div class="user-input-wrp pas"><br/>
            <?php echo Form::password('password',['class'=>'inputText', 'id'=>'password_register','required' => '']); ?>
        ...
        <div class="user-input-wrp pas"><br/>
            ...
            <?php echo Form::password('confirm_password',['class'=>'inputText', 'id'=>'confirm_password','required' => '']); ?>
        ...
        <div class="rdo">
            ...
            <label class="container_rdo col-md-3 col-xs-3">
                <?php echo Form::radio('gender','Male',null,['class'=>'inputText gender', 'id'=>'gender','required' => '','checked'=>'checked' ]); ?>

                <span class="checkmark_rdo">Male</span>
            </label>
            <label class="container_rdo col-md-3 col-xs-3">

                <?php echo Form::radio('gender','Female',null,['class'=>'inputText gender', 'id'=>'gender','required' => '' ]); ?>
