...
<!--                  <th  width="15%" align="center"><?php echo e(trans('admin.PROFILE_IMAGE')); ?></th>-->
              ...
              <th width="20%"><?php echo \Kyslik\ColumnSortable\Sortable::link(array ('first_name', 'Customer Detail'));?></th>
              <th width="15%">Order no</th>
              <th width="15%">Shipping <br>Address</th>
              <th width="15%">Shipping <br>Details</th>
              <th width="15%">Pay Mode</th>
              <th width="10%">Cart <br> Total</th>
              <th width="15%">Order <br> Status</th>
              <th width="15%">Payment <br> Status</th>
              <th width="10%"><?php echo \Kyslik\ColumnSortable\Sortable::link(array ('created_at', 'Order date'));?></th>
           ...
           <tr>
             ...
             <!-- <td><?php echo e($order->profile_img); ?></td>-->
             <td><?php echo e($order->order_no); ?></td>
             <td><?php echo e($order->address_1); ?>, <?php echo e($order->address_2); ?></td>
             <td>Method: Standard Method<br> 
				Shipping Amount : <?php echo e($order->shipping_amount); ?></td>
              <td><?php echo e($order->pay_mode); ?></td>
              <td><?php echo e($order->item_total_amount + $order->shipping_amount); ?></td>
