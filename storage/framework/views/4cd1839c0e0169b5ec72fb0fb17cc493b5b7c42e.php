      ...
      <section id="mustHave-products-area" class="pt-90 pt-md-60 pt-sm-50 products_listing_sec">
         <div class="container">
            <div class="row sort_topp">
               <div class="col-md-3">
                   <?php if($title): ?>
                  <h3><?php echo e(ucfirst($title)); ?></h3>
                  <?php endif; ?>
               </div>
               <div class="col-md-9">
                  <ul>
...
<!--                     <li>
                     ...
                     <li><a href="#"><?php echo \Kyslik\ColumnSortable\Sortable::link(array ('price', 'Price'));?></a></li>
<!--                     <li><a href="#"><?php echo \Kyslik\ColumnSortable\Sortable::link(array ('created_at', 'Price - High to Low'));?></a></li>-->
                     <li><a href="#"><?php echo \Kyslik\ColumnSortable\Sortable::link(array ('created_at', 'Newest First'));?></a></li>
                  </ul>
                   <?php $i = $products2->perPage() * ($products2->currentPage() - 1);
                   //echo $i.'dd'.$products->perPage().'fff'.$products->currentPage().'ssfff'.$products->count();
                   ?>
                  <p>Showing <?php echo e($i+1); ?>–<?php echo e($products2->count()); ?> of <?php echo e($products2->total()); ?> results</p>
               </div>
            </div>
            <div class="row no-gutters listing_product_show_row">
               <div class="col-md-3 side_stick sticky" >
                  <h2>Filters</h2>
                  <a href="<?php echo e(URL::to($URL)); ?>" class="clear">Clear all</a>
                  <?php echo Form::open(array('novalidate' => 'novalidate','method' => 'GET','id'=>'search_form','name'=>'search_form')); ?>

                 
                  <div class="col-md-12 mean_cat">
                      <?php if(!empty($category_lists)): ?>
                      <?php //$catLists = CommonHelpers::getcatlist(); ?>
                      <?php foreach($category_lists as $key=>$catList): ?>
                     <label class="container_checkbx"><?php echo e(ucfirst($catList->cat_name)); ?>

                         
                      <input type="checkbox" name="cats[]" value="<?php echo e($catList->id); ?>" <?php if(in_array($catList->id,$catArr)){?> checked="checked" <?php }?> />
                  ...
                  <div class="col-md-12 size">
                     ...
                     <div class="p">
                        ...
                        <ul id="panel_size">
                           ...
                           <?php foreach($sizeLists as $key=>$value): ?>                           
                           <li class="<?if($key==0){?>active_size<?}?>">
                              <?php /*?>{!! Form::checkbox('sizes[]',$value->id, Input::get('size'), array(
                               ...
                               <input type="checkbox" name="sizes[]" value="<?php echo e($value->id); ?>" <?php if(in_array($value->id,$sizeArr)){?> checked="checked" <?php }?> />                   
                               <a href="#"><?php echo e($value->size); ?></a>                  
                           </li>                           
                           <?php endforeach; ?>
                     ...
                     <div class="p">
                        ...
                        <div id="panel_color">
                            ...
                            <?php $colorLists = CommonHelpers::getcolorlist();?>
                               <?php foreach($colorLists as $key=>$colorList): ?>
                           <label class="container_checkbx"><?php echo e(ucfirst($colorList->color_name)); ?>

                               
                           <input type="checkbox" name="colors[]" value="<?php echo e($colorList->id); ?>" <?php if(in_array($colorList->id,$colorArr)){?> checked="checked" <?php }?> />
                           
                           <span class="ck_span"  style="background:<?php echo e($colorList->color_picker); ?>;"></span> 
                           <span class="checkmark_checkbx"></span>
                           </label>
                           <?php endforeach; ?>
                     ...
                     <div class="p">
                        ...
                        <div id="panel_price">
                           ...
                           <div class="slct1 col-md-12">
                               ...
                               ?>
                              <?php echo Form::select('min_price', $minPrice, $minArr, ['id'=>'min_price','class' => 'col-md-4 col-xs-4']); ?>


                              <p class="col-md-4 col-xs-4">To</p>
                              <?php echo Form::select('max_price', $maxPrice, $maxArr, ['id'=>'max_price','class' => 'col-md-4 col-xs-4']); ?>
...
<!--                               <input type="checkbox" checked="checked" value="4">-->
                  ...
                  <div class="products-wrapper">
                     <div class="product-category-filter-wrap">
                        ...
                        <?php $colorLists = CommonHelpers::getProductColor_image($product->color_id, $product->id);
                               ...
                               <?php if(!empty($colorLists) && !empty($images)): ?>
                        <div class="col-md-4 single-product-wrap men kid bagshoes">
                           <figure class="product-thumbnail">
                               
                               
                              <a href="<?php echo e(URL::to('productDetail/'.$product->slug.'/'.$colorLists->slug)); ?>" class="d-block">
							 ...
							 <?php endif; ?>
                              ...
                              <figcaption class="product-hvr-content">
                                 <div class="btn-black btn-addToCart">
                                    <a id="myBtn_view" attId="<?php echo e($key); ?>" class="view_btn_class" ><i class="fa fa-eye" aria-hidden="true"></i></a>
                                    ...
                                    <a name="wishlist_btn"  id="wishlist_btn_red" attrId="<?php echo e($product->id); ?>" attrColor ="<?php echo e($product->color_id); ?>" class="last_icn wishBtnManageColor wishlist_btn_red wishlist-btn-color">
                                    <i class="fa fa-heart" aria-hidden="true"></i>
                                    </a>
                                    <?php else: ?> 
                                    <a name="wishlist_btn" id="wishlist_btn" attrId="<?php echo e($product->id); ?>" attrColor ="<?php echo e($product->color_id); ?>" class="last_icn wishlist_btn wishBtnManageColor">
                                    <i class="fa fa-heart" aria-hidden="true"></i>
                                    </a>
                                    <?php endif; ?>
                                    <?php else: ?>
                                  ...
                                  <?php if(isset($product->discount) && !empty($product->discount) && $product->discount != 0.00): ?>
                                     <span class="product-badge">-<?php echo e($product->discount); ?>%</span>
                                    <?php else: ?>
                           ...
                           <div class="product-details">
                              <h2 class="product-name">
                                  <a href="<?php echo e(URL::to('productDetail/'.$product->slug.'/'.$colorLists->slug)); ?>"><?php echo e($product->product_title); ?></a></h2>
                              <div class="product-prices">
                                ...
                                ?>
                                 <span class="price"><?php echo CURRENCY; ?>&nbsp;<?php echo e($discount_price); ?></span>
                                  <?php if(isset($product->discount) && !empty($product->discount) && $product->discount != 0.00): ?>
                                 <del class="oldPrice"><?php echo CURRENCY; ?>&nbsp; 
                                     <?php if(CURRENCY == '<i class="fa fa-usd" aria-hidden="true"></i>'): ?>
                                     <?php echo e($product->price_usd); ?>
			...
			<?php echo $products2->appends(Input::all('page'))->render(); ?>
...
<!--                  <script>
    ...
    $.ajax({
        url: '<?php echo e(URL::to("/")); ?>/productCat/<?php echo e($slug); ?>/<?php echo e($subCatSlug); ?>/<?php echo e($subsubCatSlug); ?>', 
        type: "POST",
        cache: false,
        processData: false,
        contentType: false,
