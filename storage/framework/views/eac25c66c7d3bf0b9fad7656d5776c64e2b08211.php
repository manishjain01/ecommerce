    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 page_link"> 
                ...
                <a href="<?php echo e(URL::to('productCat/'.$productDetail[0]['product_category']['slug'])); ?>">
                    <?php echo e(ucfirst($productDetail[0]['product_category']['cat_name'])); ?> 
                    </a>
                    <?php if(!empty($productDetail[0]['product_subcategory'])): ?>
                    <a href="<?php echo e(URL::to('productCat/'.$productDetail[0]['product_category']['slug'].'/'.$productDetail[0]['product_subcategory']['slug'])); ?>">
                    / <?php echo e(ucfirst($productDetail[0]['product_subcategory']['cat_name'])); ?>

                     </a>
                    <?php endif; ?>
                    <?php if(!empty($productDetail[0]['product_sub_subcategory'])): ?>
                    <a href="<?php echo e(URL::to('productCat/'.$productDetail[0]['product_category']['slug'].'/'.$productDetail[0]['product_subcategory']['slug'].'/'.$productDetail[0]['product_sub_subcategory']['slug'])); ?>">
                     / <?php echo e(ucfirst($productDetail[0]['product_sub_subcategory']['cat_name'])); ?>
        ...
        <div class="row product_img_detail_row">
                    ...
                    <div class="product-thumb-large-view">
                        <div class="product-thumb-carousel vertical-tab">
                            ...
                            <figure class="product-thumb-item">
                                <img src="<?php echo e(PRODUCT_IMAGE_URL.$value['image_name']); ?>" alt="Single Product"/>
                            </figure>
                            <?php endforeach; ?>
                        </div>
            ...
            <div class="col-md-6 pricde_detl">
                ...
                <div class="col-md-12">
                    ...
                    <li>
                        ...
                        <a href="javascript:void(0)" id="review_scroll">
                            ...
                            <? } ?>
                            <span>Review</span> <?php echo e($reviews_count); ?>
                    ...
                    <input type="hidden" value="<?php echo e($cart_usd_discount); ?>" id="discount" />
                    <input type="hidden" name="price_usd" value="<?php echo e($cart_usd_price); ?>" id="price"/>
                    <?php else: ?>
                    ...
                    <input type="hidden" value="<?php echo e($cart_usd_discount); ?>" id="discount_usd_cart" />
                    <input type="hidden" value="<?php echo e($cart_usd_price); ?>" id="price_usd_cart"/>
                    <input type="hidden" value="<?php echo e($cart_discount); ?>" id="discount_cart" />
                    <input type="hidden" name="price" value="<?php echo e($cart_price); ?>" id="price_cart"/>
                    
                    <p> 
                        <?php echo CURRENCY; ?>&nbsp;<?php echo e($discount_price); ?> 
                        <?php if(isset($discount) && !empty($discount) && $discount != 0.00): ?>
                            <b>
                            <?php echo CURRENCY; ?>&nbsp;
                            <?php if(CURRENCY == '<i class="fa fa-usd" aria-hidden="true"></i>'): ?>
                            <?php echo e(number_format($productDetail[0]['price_usd'], 2)); ?>
                    ...
                    <ul> 
                        ...
                        <li>
                            <a href="javascript::void(0);" >
                                <strike><?php echo e($size[0]['size']); ?></strike>
                            </a>
                        </li>
                        <?php else: ?>                        
                ...
                <div class="col-md-12 qty">
                    ...
                    <a href="javascript::void(0);" attrId="<?php echo e($productDetail[0]['id']); ?>" attrColor ="<?php echo e($colorId); ?>" class="wish_deail wishBtnManageColor wishlist_btn_red wishlist-btn-color">
                        <i class="fa fa-heart icon-fontaweson" aria-hidden="true"></i>
                    </a>
                    <?php else: ?>
                    <a href="javascript::void(0);" attrId="<?php echo e($productDetail[0]['id']); ?>" attrColor ="<?php echo e($colorId); ?>" class="wish_deail wishlist_btn wishBtnManageColor" style="color:black;">
                        <i class="fa fa-heart icon-fontaweson" aria-hidden="true"></i>
                    </a>
                    <?php endif; ?>
                    <?php else: ?>
                ...
                <div class="col-md-12 add_crd">
                    ...
                    <a href = "javascript:void(0);" style="margin-top:15px;">
                        <?php echo Form::button('BUY NOW',['class'=>'by_now','attrId'=>$productDetail[0]['id']]); ?>

                        </a>
                    <a href = "javascript:void(0);" >
                        <?php echo Form::button('ADD TO CART',['class'=>'cart_btn cart_btn','attrId'=>$productDetail[0]['id']]); ?>

                    </a>
<!--                    <a href="javascript::void(0);" class="cart_btn cart_btn" attrId="<?php echo e($productDetail[0]['id']); ?>">ADD TO CART</a>-->
                </div>
                <?php echo Form::close(); ?>
                ...
                <div class="col-md-12 promo_code">
                    ...
                    <?php echo Form::open(array('novalidate' => 'novalidate','files'=>true,'id'=>'pincode_form')); ?>
        ...
        <div class="row">
            <div class="col-md-12 pro_detail_desc">
                ...
                <p><?php echo e(strip_tags($productDetail[0]['product_description'])); ?></p>
            </div>
        </div>
        <div class="row detal_tabs">
            <div class="col-xs-12 ">
                ...
                <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    ...
                    <?php foreach(array_intersect_key($productDetail[0]['product_color'], $ss) as $key=>$value): ?>
                ...
                ?>
                    <?php foreach(array_intersect_key($productDetail[0]['product_color'], $sss) as $key=>$value): ?>
                    
                                   
                                    <?php //pr($value);
                                    $color = CommonHelpers::getColor($value['color_id']);
                                    ?>
                                    <?php echo e(ucfirst($color[0]['color_name'])); ?>,
                                    <?php endforeach; ?>
                                </td>
                            </tr>

                            <?php if($productDetail[0]['neckline']): ?>
                            <tr>
                                <td>NeckLine:</td>
                                <td><?php echo e($productDetail[0]['neckline']); ?></td>
                            </tr>
                            <?php endif; ?>

                            <?php if($productDetail[0]['fabric']): ?>
                            <tr>
                                <td>Fabric:</td>
                                <td><?php echo e($productDetail[0]['fabric']); ?></td>
                            </tr>
                            <?php endif; ?>


                            <?php if($productDetail[0]['season']): ?>
                            <tr>
                                <td>Season:</td>
                                <td><?php echo e($productDetail[0]['season']); ?></td>
                            </tr>
                            <?php endif; ?>
            ...
            <div id="carouselPlus" class="carousel slide multi-carousel" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-grid col-lg-3 col-md-4 col-sm-12">
                        <a href="<?php echo e(URL::to('productDetail/'.$relatedProduct['slug'].'/'.$colorLists->slug)); ?>"><img class="d-block w-100" src="<?php echo e(PRODUCT_IMAGE_URL.$relatedProduct['product_image'][0]['image_name']); ?>" alt="First slide"></a>
                        <div class="nm_po">
                            <a href="<?php echo e(URL::to('productDetail/'.$relatedProduct['slug'].'/'.$colorLists->slug)); ?>"><h4><?php echo e($relatedProduct['product_title']); ?></h4></a>
                            ...
                            <p><?php echo CURRENCY; ?>&nbsp;<?php echo e($discount_price); ?>  <b>
                                    <?php echo CURRENCY; ?>&nbsp;
                                    <?php if(CURRENCY == '<i class="fa fa-usd" aria-hidden="true"></i>'): ?>
                                    <?php echo e($relatedProduct['price_usd']); ?>
        ...
        <div class="row review_rating_row">
            ...
            <div class="col-md-12">
                <ul>
                    ...
                    <li>
						...
						<?php if(isset($productReview->profile_img) && !empty($productReview->profile_img)): ?>
                                                    <?php if(substr($productReview->profile_img, 0, 4) == 'http'): ?>
                                                        <img src="<?php echo e($productReview->profile_img); ?>">
                                                    <?php else: ?> 
                ...
                <div class="col-md-12 view_all">
                    <a href="<?php echo e(URL::to('allReviews/'.$productDetail[0]['id'].'/'.$productDetail[0]['slug'])); ?>">View all</a></div>
                <?php endif; ?>
            </div>
         ...
         <div class="modal-body">
            <div class="stars">
              ...
              <?php echo Form::open(array('novalidate' => 'novalidate','files'=>true,'id'=>'review_form')); ?>
                  ...
                  <?php echo Form::submit('Submit',['class' => 'btn btn-default btn-submit','id' =>'review']); ?>
