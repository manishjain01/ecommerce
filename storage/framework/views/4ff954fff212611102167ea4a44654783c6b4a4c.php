...
<!--                <div class="col-md-12 hdhng_row">
                ...
                <div class="col-md-12 hdhng_row">
                    ...
                    <div class="col-md-6">
                        <p class="del_address"><?php if(isset($users[0]->address_1) && !empty($users[0]->address_1)): ?>  
...
<!--                            <input type="hidden" name="order_no" value="1000">-->
                ...
                <div class="col-md-12 hdhng_row">
                    ...
                    <div class="col-md-6"><p>1 <span>item</span> Total <?php echo CURRENCY; ?>&nbsp;<?php echo e($orders->item_total_amount); ?><p>
                    </div> 
    ...
    padding-right: 7px;"><?php echo CURRENCY; ?>&nbsp;<?php echo e($orders->discount); ?> 
                                    </span>
            ...
            <div class="col-md-4">
                <div class="col-md-12  order_lstt">
                    ...
                    <div class="col-md-12">
                        ...
                        <p class="ryt ryt1">- <?php echo CURRENCY; ?>&nbsp;<?php echo e($orders->discount); ?></p>
                    </div>
                        <?php endif; ?>
