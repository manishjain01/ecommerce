...
<section class="content-header">
  ...
  <?php echo Html::decode(Html::link(route('admin.addsubcategory', $slug),"<i class='fa  fa-plus'></i>",['class'=>'btn btn-primary','data-toggle'=>'tooltip','title'=>trans('Add')])); ?>				  
...
<!--                  <th  width="15%" align="center"><?php echo e(trans('admin.PROFILE_IMAGE')); ?></th>-->
           ...
           <tr>
              ...
              <td>
                        <?php echo Html::decode(Html::link(route('admin.editsubcategory', [$category->slug, $slug]),"<i class='fa  fa-edit'></i>",['class'=>'btn btn-primary','data-toggle'=>'tooltip','title'=>trans('admin.EDIT')])); ?>				  
                           <?php /*?> {!! Form::model($category, ['url' => '/admin/categories/subindex/' . $category->id.'/'.$slug]) !!}
                            ...
                            {!! Form::close() !!}<?php */?>
                        <?php echo Html::decode(Html::link(route('admin.subsubindex', $category->slug),"<i class='fa fa-th'></i>",['class'=>'btn btn-primary','data-toggle'=>'tooltip','title'=>'Sub Sub Category'])); ?>
