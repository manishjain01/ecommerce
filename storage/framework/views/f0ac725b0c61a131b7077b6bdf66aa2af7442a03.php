									...
									<div style="width:198%;">
										<div style="float:left; width:98%;margin-left: 1%;">
											<?php echo Form::text('product_title', Input::get('product_title'), array(
												'required', 
												'class' => 'form-control', 
												'placeholder' => 'Search by Product Title, Price, Code'
											));; ?>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th width="5%">S.No</th>
                                    <th width="15%"><?php echo \Kyslik\ColumnSortable\Sortable::link(array ('title', 'Product Title'));?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php $sizes = array();?>
                                        <?php foreach($prodcut->product_color as $products): ?>
                                         <?php $size = CommonHelpers::getSize($products->size_id); 
                                         $sizes[] = $size['0']['size'];
                                         ?>
                                        <?php echo e($products->colors->color_name); ?>,
                                        <?php endforeach; ?>
                                    </td>
                                    <td>
