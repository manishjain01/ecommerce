...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <?php echo Form::model($product,['method'=>'patch','route'=>['admin.products.update',$product->id],'files'=>true]); ?>
            ...
            <div class='box-body-inner col-md-10'>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group ">
                           <?php echo Form::label('Select Sub Sub Category',null,['class'=>'']); ?>

                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                              <?php echo Form::select('sub_sub_category_id', $sub_sub_category_lists,null, ['id'=>'sub_sub_category_id','class' => 'form-control']); ?>
               ...
               <?php if(!$product->product_color->isEmpty()): ?>
               ...
               <div class="prd-containor">
                ...
                <div class="row">
                    ...
                    <?php foreach($product->product_color as $key=>$value): ?>
                    <?php if($key!=0): ?>
                    <div class="col-md-4">
                     </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
							<?$color_name = CommonHelpers::colorName($value['color_id']);?>
							   ...
							   <?php echo Form::text('proattr['.$key.'][color_id]',$color_name[0]['color_name'],['class'=>'form-control','disabled' => true]); ?>

                               <div class="error"><?php echo e($errors->first('color_id['.$key.']')); ?></div>
                          </div>
                    </div>
				...
				<?php $size = CommonHelpers::sizeName($value['size_id']);?>
                               <?php echo Form::text('proattr['.$key.'][size_id]',$size[0]['size'],['class'=>'form-control','disabled' => true]); ?>

                               <div class="error"><?php echo e($errors->first('size_id['.$key.']')); ?></div>
                          </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo Form::input('number','proattr['.$key.'][quantity]',$value['quantity'],['class'=>'form-control qty'.$value['id'],'min'=>1,'disabled'=>true]); ?>

                            <div class="error"><?php echo e($errors->first('quantity['.$key.']')); ?></div>
                            <span class="qbtn" dataid = "<?php echo e($value['id']); ?>"><i class="fa fa-ban" aria-hidden="true"></i></span>
                        </div>
                     ...
                     <div class="col-md-1">
                         ...
                         <a class="btn btn-info update_qty" ProductColorId="<?php echo e($value['id']); ?>" title="Update Qty"><i class="fa  fa-edit"></i></a>
                           
                            </div>
                        </div>                   
                    <?php if($product->product_color->count() > 1): ?>
                    <div class="col-md-1">
				<a class="btn btn-danger confirm_link confirm_delete" attrProId="<?php echo e($value['product_id']); ?>" attrColorId="<?php echo e($value['color_id']); ?>" attrId="<?php echo e($value['id']); ?>" title="Remove"><i class="fa  fa-remove"></i></a>
                    </div>
                    <?php endif; ?>
               ...
               <div class="prd-containor">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group ">
                           <?php echo Form::label('Select Parameter',null,['class'=>'']); ?>
               ...
               <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group ">
                            <?php echo Form::label('Price(USD)',null,['class'=>'required_label']); ?>

                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            <?php echo Form::text('price_usd',null,['class'=>'form-control','placeholder'=>'Price in USD']); ?>

                            <div class="error"><?php echo e($errors->first('price_usd')); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                 ...
                 <div class="row">
                    <div class="col-md-4">
                        <div class="form-group ">
                            <?php echo Form::label('Fabric',null,['class'=>'']); ?>

                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            <?php echo Form::text('fabric',null,['class'=>'form-control','placeholder'=>'Fabric']); ?>

                            <div class="error"><?php echo e($errors->first('fabric')); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group ">
                            <?php echo Form::label('Neckline',null,['class'=>'']); ?>

                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            <?php echo Form::text('neckline',null,['class'=>'form-control','placeholder'=>'Neckline']); ?>

                            <div class="error"><?php echo e($errors->first('neckline')); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group ">
                            <?php echo Form::label('Season',null,['class'=>'']); ?>

                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            <?php echo Form::text('season',null,['class'=>'form-control','placeholder'=>'Season']); ?>

                            <div class="error"><?php echo e($errors->first('season')); ?></div>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <?php echo Form::radio('featured','0',null,['class'=>'inputText gender', 'id'=>'featured','required' => '' ]); ?>
...
<script>
	...
	$(".confirm_delete").on('click', function(event){
		...
		$.ajax({
		url: '<?php echo ADMIN_URL; ?>products/product_parameter/' + id + '/'+product_id+'/'+color_id,
            type: "GET",
            dataType: "json",
...
$(".update_qty").on('click', function(event){		
		var id = $(this).attr("ProductColorId");
                var qty = $('.qty'+id).val();
		$.ajax({
		url: '<?php echo ADMIN_URL; ?>products/product_qtyupdate/' + id + '/'+qty,
            type: "GET",
            dataType: "json",
