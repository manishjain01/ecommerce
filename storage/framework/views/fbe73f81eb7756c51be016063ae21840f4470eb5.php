        ...
        <div class="row order_row">
            <div class="col-md-8">
                <div class="col-md-12 hdhng_row">
                    ...
                    <div class="col-md-6"><p><?php echo e($users[0]->email); ?> <p></div> 
...
<!--                            <input type="hidden" name="order_no" value="1000">-->
                ...
                <div class="col-md-12 hdhng_row"><?php //echo $isdisabled;?>
                    <div class="col-md-4">
                        <img src="<?php echo e(asset('img/image1.png')); ?>" class="img1">
                        <img src="<?php echo e(asset('img/check-icon.png')); ?>" class="img2">
                        <p>Order Summery<p>
                    </div> 
                    ...
                    <div class="col-md-12 cl_rvw_sec">
                        ...
                        <div class="col-md-12 oder_revw1">
                            ...
                            <div class="col-md-9 rv_cont">
                                ...
                                <p class="price"><?php echo CURRENCY; ?>&nbsp;
                                    <?php if(CURRENCY == '<i class="fa fa-usd" aria-hidden="true"></i>'): ?>
                                    <?php echo e($cart_detail->price_usd*$cart_detail->qty + $cart_detail->discount_usd*$cart_detail->qty); ?>
    ...
    padding-right: 7px;">       
                                ...
                                <?php echo CURRENCY; ?>&nbsp;<?php echo e($cart_detail->discount_usd*$cart_detail->qty); ?> </span><br/><?php echo CURRENCY; ?>&nbsp;
                                <?php echo e($cart_detail->price_usd*$cart_detail->qty); ?> 
                                <?php endif; ?>
                                <?php else: ?>
                                <?php if(isset($cart_detail->discount) && !empty($cart_detail->discount) && $cart_detail->discount != 0.00): ?>
                                <?php echo CURRENCY; ?>&nbsp;<?php echo e($cart_detail->discount*$cart_detail->qty); ?> </span><br/><?php echo CURRENCY; ?>&nbsp;
...
<!--                                <span>Floral Print Slip Dress</span>-->
                                ...
                                <p class="stock" data_productid = "<?php echo e($cart_detail->product_id); ?>" data_colorid = "<?php echo e($cart_detail->color_id); ?>" data_sizeid = "<?php echo e($cart_detail->size_id); ?>" data_qty = "<?php echo e($cart_detail->qty); ?>">
                                    <span><b>Size</b>&nbsp; &nbsp;&nbsp;<?php echo e($size[0]['size']); ?></span> 
                                    <span><b>Qty</b>&nbsp;&nbsp;&nbsp; <?php echo e($cart_detail->qty); ?></span></p>
                ...
                <div class="col-md-12 hdhng_row hdhng_row_lst">
                    ...
                    <div class="col-md-6"><p class="grand_total"><?php echo e($countCart); ?><span>&nbsp;Item</span> Total <?php echo CURRENCY; ?>&nbsp;<?php echo e($grand_total); ?></p>
                        <p class="total_amount" style="display:none;"><?php echo e($countCart); ?><span>&nbsp;Item</span> Total <?php echo CURRENCY; ?>&nbsp;<?php echo e($total); ?></p>
                    </div> 
