...
<!--
          <input type="text" class="form-control" placeholder="Delievery Address" name="address" value="<?php echo e($users[0]->first_name); ?> <?php echo e($users[0]->last_name); ?>">
-->
...
<!--                            <input type="hidden" name="order_no" value="1000">-->
               ...
               if(empty($users[0]->address_1)){
                  $isdisabled = true;  
               }else if(empty($users[0]->phone)){
                  $isdisabled = true;  
               }else if(empty($users[0]->city_name)){
                  $isdisabled = true;  
               }else if(empty($users[0]->state_name)){
                  $isdisabled = true;  
               }else if(empty($users[0]->pincode)){
                  $isdisabled = true;  
               } 
                ?>
                <div class="col-md-12 hdhng_row">
                    ...
                    <div class="col-md-6"><p><?php echo e($countCart); ?> <span>item</span> Total <?php echo CURRENCY; ?>&nbsp;<?php echo e($price); ?><p>
                    </div> 
                        ...
                        <div class="col-md-12 oder_revw1">
                            ...
                            <div class="col-md-9 rv_cont">
                                ...
                                <p class="price">
                                    ...
                                    <?php echo CURRENCY; ?>&nbsp;<?php echo e($cart_detail->price_usd*$cart_detail->qty + $cart_detail->discount_usd*$cart_detail->qty); ?>

                                    <?php else: ?>
                                    <?php echo CURRENCY; ?>&nbsp;<?php echo e($cart_detail->price*$cart_detail->qty + $cart_detail->discount*$cart_detail->qty); ?>
                                    ...
                                    padding-right: 7px;">       
                                 <?php if(CURRENCY == '<i class="fa fa-usd" aria-hidden="true"></i>'): ?>       
                                <?php echo CURRENCY; ?>&nbsp;<?php echo e($cart_detail->discount_usd*$cart_detail->qty); ?> 
                                    </span><br/>
                                <?php echo CURRENCY; ?>&nbsp;<?php echo e($cart_detail->price_usd*$cart_detail->qty); ?> <br>
                                <?php else: ?>
                                <?php echo CURRENCY; ?>&nbsp;<?php echo e($cart_detail->discount*$cart_detail->qty); ?> </span><br/>
                                <?php echo CURRENCY; ?>&nbsp;<?php echo e($cart_detail->price*$cart_detail->qty); ?> <br>
                                <?php endif; ?>
                                <?php endif; ?>
                                </p>
<!--                                <span>Floral Print Slip Dress</span>-->
                                <?php $size = CommonHelpers::getSize($cart_detail->size_id); ?>
                                <p class="stock" data_productid = "<?php echo e($cart_detail->product_id); ?>" data_colorid = "<?php echo e($cart_detail->color_id); ?>" data_sizeid = "<?php echo e($cart_detail->size_id); ?>" data_qty = "<?php echo e($cart_detail->qty); ?>">
                                    <span><b>Size</b>&nbsp; &nbsp;&nbsp;<?php echo e($size[0]['size']); ?></span> <span><b>Qty</b>&nbsp;&nbsp;&nbsp; <?php echo e($cart_detail->qty); ?></span></p>
                                <p class="check_stock<?php echo e($cart_detail->product_id.$cart_detail->color_id.$cart_detail->size_id); ?> error"></p>
                            </div>
                        </div>
                        <?php endforeach; ?>
                        <?php else: ?>
                ...
                <div class="col-md-12 hdhng_row hdhng_row_lst">
                    ...
                    <div class="col-md-6"><p class="grand_total"><?php echo e($countCart); ?><span>&nbsp;Item</span> Total <?php echo CURRENCY; ?>&nbsp;<?php echo e($grand_total); ?></p>
                        <p class="total_amount" style="display:none;"><?php echo e($countCart); ?><span>&nbsp;Item</span> Total <?php echo CURRENCY; ?>&nbsp;<?php echo e($total); ?></p></div> 
            ...
            <div class="col-md-4">
                <div class="col-md-12  order_lstt">
                    ...
                    <div class="col-md-12"> <p class="lft">Bag Total<span>(Inculsive all taxes)</span></p>
                        <p class="ryt"><?php echo CURRENCY; ?>&nbsp;<?php echo e($total + $discount_price); ?></p></div>
                        <?php if(isset($discount_price) && !empty($discount_price) && $discount_price != 0.00): ?>
                    <div class="col-md-12">
                        <p class="lft">Bag Discount</p>
                        <p class="ryt ryt1">- <?php echo CURRENCY; ?>&nbsp;<?php echo e($discount_price); ?></p>
                    </div>
                        <?php endif; ?>
