        ...
        <div class="row">
            ...
            <?php /* ?><h3 class="pull-right">  
                {!!  Html::decode(Html::link(route('admin.users.create'),"<i class='fa  fa-plus'></i>".trans('admin.ADD_NEW'),['class'=>'btn btn-primary'])) !!}
                    ...
                    <h3 class="pull-right">  
                        <?php echo Html::decode(Html::link(route('admin.banner.create'),"<i class='fa  fa-plus'></i>".trans('admin.ADD_NEW'),['class'=>'btn btn-primary'])); ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="cut_btn">
                                        <?php echo Form::model($banner, ['method' => 'DELETE', 'url' => '/admin/banner/' . $banner->id]); ?>
