...
<!--                  <th  width="15%" align="center">{{trans('admin.PROFILE_IMAGE')}}</th>-->
              ...
              <th width="20%">@sortablelink('first_name', 'Customer Detail')</th>
              ...
              <th width="10%">@sortablelink('created_at', 'Order date')</th>
           ...
           <tr>
             ...
             <!-- <td>{{$order->profile_img}}</td>-->
             <td>{{$order->order_no}}</td>
             <td>{{$order->address_1}}, {{$order->address_2}}</td>
             <td>Method: Standard Method<br> 
				Shipping Amount : {{$order->shipping_amount}}</td>
              <td>{{$order->pay_mode}}</td>
              <td>{{$order->item_total_amount + $order->shipping_amount}}</td>
