...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box-header with-border">
            <h3 class="pull-right">  
                {!!  Html::decode(Html::link(route('admin.subindex', $mainslug),"<i class='fa  fa-arrow-left'></i>".trans('admin.BACK'),['class'=>'btn btn-block btn-primary'])) !!}
            </h3>
        </div>
        <!-- SELECT2 EXAMPLE -->
        <div class="box box-primary">

            {!! Form::model($category,['route'=>['admin.editsubcategory.update',$category->slug, $mainslug],'files'=>true]) !!}
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group ">
                                {!! Form::label('Sub Category Name',null,['class'=>'required_label']) !!}
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                {!! Form::text('cat_name',null,['class'=>'form-control','placeholder'=>'Sub Category Name']) !!}
