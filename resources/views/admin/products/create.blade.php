            ...
            <div class='box-body-inner col-md-10'>
               ...
               <!--<script type="text/javascript">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group ">
                            {!! Form::label('Price(USD)',null,['class'=>'required_label']) !!}
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            {!! Form::text('price_usd',null,['class'=>'form-control','placeholder'=>'Price in USD']) !!}
                            <div class="error">{{ $errors->first('price_usd') }}</div>
                        </div>
                    </div>
                </div>
