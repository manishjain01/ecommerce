        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-1 text18" id = "attach{{$attachments->id}}">                                          
                               ...
                               <p onclick = "remove_attachment({{$attachments->id}}, {{$attachments->product_id}})" class="text20"><i class="fa fa-trash"></i></p>
                            {{ $attachments->product_image_color->color_name }}
                            </div>
                            @endforeach
                            @endif
                        </div>
                                ...
                                <div class="controls">
                                    <div class="entry input-group col-md-12">
                                        <input class="upload-button image" name="image_attr[][image_name]" type="file" value="Upload Your Fille" accept="image/*" onChange = readURL(this);>                                        
                                         {!! Form::select('image_attr[][color_id]', $color_List, null, ['selected'=>'selected','class' => 'form-control']) !!}
            ...
            <div class="box-footer">
                <div class="pull-right">
                    ...
                    {!! Form::submit(trans('admin.SAVE'),['class' => 'btn btn-info', 'id' => 'submit'])!!}
                </div>
            </div>
            <!-- /.box-footer -->
            {!! Form::close() !!}
...
<script> 
    ...
    if ((file = input.files[0])) {
        ...
        img.onload = function() {
			...
			if ((height > 650 && height < 750) && (width > 500 && width < 600)) {
