                    ...
                    <div class="col-md-12 cl_rvw_sec">
                        ...
                        <div class="col-md-12 oder_revw1">
                            ...
                            <div class="col-md-9 rv_cont">
                                ...
                                <p class="price">
                                    @if(CURRENCY == '<i class="fa fa-usd" aria-hidden="true"></i>')
                                    {!! CURRENCY !!}&nbsp;{{ $cart_detail->price_usd*$cart_detail->qty + $cart_detail->discount_usd*$cart_detail->qty}}
                                    @else
                                    {!! CURRENCY !!}&nbsp;{{ $cart_detail->price*$cart_detail->qty + $cart_detail->discount*$cart_detail->qty}}
                                    @endif
                                    <br/>
                                    ...
                                    padding-right: 7px;">       
                                 @if(CURRENCY == '<i class="fa fa-usd" aria-hidden="true"></i>')       
                                {!! CURRENCY !!}&nbsp;{{ $cart_detail->discount_usd*$cart_detail->qty }} 
                                    </span><br/>
                                {!! CURRENCY !!}&nbsp;{{ $cart_detail->price_usd*$cart_detail->qty }} <br>
                                @else
                                {!! CURRENCY !!}&nbsp;{{ $cart_detail->discount*$cart_detail->qty }} </span><br/>
                                {!! CURRENCY !!}&nbsp;{{ $cart_detail->price*$cart_detail->qty }} <br>
                                @endif
                                @endif
                                </p>
<!--                                <span>Floral Print Slip Dress</span>-->
                                ...
                                <p class="stock" data_productid = "{{$cart_detail->product_id}}" data_colorid = "{{$cart_detail->color_id}}" data_sizeid = "{{$cart_detail->size_id}}" data_qty = "{{$cart_detail->qty}}">
                                    <span><b>Size</b>&nbsp; &nbsp;&nbsp;{{$size[0]['size']}}</span> <span><b>Qty</b>&nbsp;&nbsp;&nbsp; {{ $cart_detail->qty }}</span></p>
                ...
                <div class="col-md-12 hdhng_row hdhng_row_lst">
                    ...
                    <div class="col-md-6"><p class="grand_total">{{$countCart}}<span>&nbsp;Item</span> Total {!! CURRENCY !!}&nbsp;{{$grand_total}}</p>
                        <p class="total_amount" style="display:none;">{{$countCart}}<span>&nbsp;Item</span> Total {!! CURRENCY !!}&nbsp;{{$total}}</p></div> 
