        ...
        <div class="row product_img_detail_row">
            ...
            <div class="col-md-6 pricde_detl">
                ...
                <div class="col-md-12">
                    ...
                    <input type="hidden" value="{{$cart_usd_discount}}" id="discount_usd" />
                    <input type="hidden" name="price" value="{{$cart_price}}" id="price"/>
                    <input type="hidden" name="price_usd" value="{{$cart_usd_price}}" id="price_usd"/>
    ...
    $(document).on("click", ".cart_btn", function () {
        ...
        $.ajax({
            ...
            success: function (msg) {                
                ...
                $(".count_wish").html(msg1.count_wishlist);
                $('.wish_deail').removeClass('wishlist-btn-color');
                $('.wish_deail').removeClass('wishlist_btn_red');
                $('.wish_deail').addClass('wishlist_btn');
