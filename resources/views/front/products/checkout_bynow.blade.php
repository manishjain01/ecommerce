...
<!--                <div class="col-md-12 hdhng_row">
                ...
                <div class="col-md-12 hdhng_row">
                    ...
                    <div class="col-md-6">
                        <p class="del_address">@if(isset($users[0]->address_1) && !empty($users[0]->address_1))  
...
<!--                            <input type="hidden" name="order_no" value="1000">-->
                ...
                <div class="col-md-12 hdhng_row">
                    <div class="col-md-4">
                        <img src="{{asset('img/image1.png')}}" class="img1"><img src="{{asset('img/check-icon.png')}}" class="img2"><p>Order Summery<p>
                    </div> 
                    <div class="col-md-6"><p>1 <span>item</span> Total {!! CURRENCY !!}&nbsp;{{ $orders->item_total_amount }}<p>
                    </div> 
                    ...
                    <div class="col-md-12 cl_rvw_sec">
                        ...
                        <div class="col-md-12 oder_revw1">
                            ...
                            <div class="col-md-9 rv_cont">
                                <h3>{{ ucfirst($order_details->product_name) }}</h3>
                                <p class="price">{!! CURRENCY !!}&nbsp; 
                                    {{ $orders->item_total_amount + $orders->discount}}
                                    <br/>
                                    @if(isset($orders->discount) && !empty($orders->discount) && $orders->discount != 0.00)
                                    <span style="float: right; font-size: 16px;
    color: red;
    font-weight: 500;
    text-decoration: line-through;
    padding-right: 7px;">{!! CURRENCY !!}&nbsp;{{ $orders->discount }} 
                                    </span>
                                    
                                    <br/>
                                {!! CURRENCY !!}&nbsp;{{ $orders->item_total_amount }} <br>
                                @endif
                                </p>
<!--                                <span>Floral Print Slip Dress</span>-->
                                <?php $size = CommonHelpers::getSize($order_details->quantity); ?>
                                <p class="stock" data_productid = "{{$order_details->product_id}}" data_colorid = "{{$order_details->color_id}}" data_sizeid = "{{$order_details->size_id}}" data_qty = "{{$order_details->quantity}}">
                                    <span><b>Size</b>&nbsp; &nbsp;&nbsp;{{$size[0]['size']}}</span> <span><b>Qty</b>&nbsp;&nbsp;&nbsp; {{ $order_details->quantity }}</span></p>
                                <p class="check_stock{{$order_details->product_id.$order_details->color_id.$order_details->size_id}} error"></p>
                            </div>
                        </div>
            ...
            $total = $orders->item_total_amount;?>
                <div class="col-md-12 hdhng_row hdhng_row_lst">
                    ...
                    <div class="col-md-6"><p class="grand_total">1<span>&nbsp;Item</span> Total {!! CURRENCY !!}&nbsp;{{$grand_total}}</p>
                        <p class="total_amount" style="display:none;">1<span>&nbsp;Item</span> Total {!! CURRENCY !!}&nbsp;{{$total}}</p></div> 
            ...
            <div class="col-md-4">
                <div class="col-md-12  order_lstt">
                    ...
                    <div class="col-md-12"> <p class="lft">Bag Total<span>(Inculsive all taxes)</span></p>
                        <p class="ryt">{!! CURRENCY !!}&nbsp;{{ $orders->item_total_amount + $orders->discount}}</p></div>
                        @if(isset($orders->discount) && !empty($orders->discount) && $orders->discount != 0.00)
                    <div class="col-md-12">
                        <p class="lft">Bag Discount</p>
                        <p class="ryt ryt1">- {!! CURRENCY !!}&nbsp;{{ $orders->discount }}</p>
                    </div>
                        @endif
