...
<!--                            <input type="hidden" name="order_no" value="1000">-->
                ...
                <div class="col-md-12 hdhng_row">
                    ...
                    <div class="col-md-6"><p>{{$orders->item_total}} <span>item</span> Total {!! CURRENCY !!}&nbsp;{{ $orders->item_total_amount }}<p>
                    </div> 
    ...
    padding-right: 7px;">{!! CURRENCY !!}&nbsp; {{ $orders->discount }} </span>
                                    @endif
                                    <br/>
            ...
            <div class="col-md-4">
                <div class="col-md-12  order_lstt">
                    ...
                    <div class="col-md-12"><p class="lft">Bag Discount</p>
                        <p class="ryt ryt1">- {!! CURRENCY !!}&nbsp;{{ $orders->discount }}</p></div>
                        @endif
