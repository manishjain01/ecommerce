         ...
         <div class="container">
            ...
            <div class="row address_row contact_fromm">
               <div class="col-md-6">
                  ...
                  {!! Form::open(['route'=>'contact_us_post','files'=>true]) !!} 
                     ...
                     <div class="form-group">
                        {!! Form::textarea('message',null,['class'=>'form-control textarea','placeholder'=>'Enter Message']) !!}
               ...
               <div class="col-md-6">
                  ...
                  <p> {!! Configure('CONFIG_POSTAL_ADDRESS') !!}</p>
                  <h4><i class="fa fa-phone" aria-hidden="true"></i> Number</h4>
                  <p> {{Configure('CONFIG_PHONE')}}</p>
                  <h4><i class="fa fa-envelope" aria-hidden="true"></i> Email ID</h4>
                  <p><a href="javascript:void(0);">{{Configure('CONFIG_FROMEMAIL')}}</a></p>
               </div>
            </div>
         </div>
