...
class BannerController extends Controller {
    ...
    public function store(Request $request) {
        ...
        $validator = validator::make($request->all(), [
                    ...
                    'image' => 'required|dimensions:max_width=1900,max_height=800,min_width=1200,min_height=700|image|mimes:' . Config::get('global.image_mime_type') . '|max:' . Config::get('global.file_max_size'),
        ]);
        if ($validator->fails()) {
    ...
    public function update(Request $request, $id) {
        ...
        $validator = validator::make($request->all(), [
                    ...
                    'image' => 'dimensions:max_width=1900,max_height=800,min_width=1200,min_height=700|image|mimes:'.Config::get('global.image_mime_type').'|max:'.Config::get('global.file_max_size'),
        ]);
        if ($validator->fails()) {
