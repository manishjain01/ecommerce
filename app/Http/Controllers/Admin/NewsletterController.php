...
//pr($newsletterlist);exit;
        ...
        $breadcrumb = array('pages' => $pages, 'active' => 'admin.newsletter.index');
    ...
    public function create() {
        ...
        $breadcrumb = array('pages' => $pages, 'active' => trans('admin.ADD_NEWSLETTER_TEMPLATE'));
    ...
    public function edit($id) {
        ...
        $breadcrumb = array('pages' => $pages, 'active' => trans('admin.EDIT_NEWSLETTER_TEMPLATE'));
    ...
    public function manageSchedule($id) {
        ...
        $breadcrumb = array('pages' => $pages, 'active' => trans('admin.MANAGE_SCHEDULE'));
