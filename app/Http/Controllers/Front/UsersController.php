...
pr($input);exit;
    ...
    public function newletter_post() {
		$email = trim(Input::get('news_email'));
    ...
    public function postReview(Request $request) {
        ...
        } elseif (empty(Input::get('comment'))) {
